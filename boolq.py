...
class BoolQDataset(Dataset):
    ...
    def __init__(self, dataframe, tokenizer, max_seq_length=256):
        ...
        self.encoded_data = data_utils.encode_data(dataframe, tokenizer, max_seq_length) # Problem here
    ...
    def __getitem__(self, i):
        ...
        dct = {}
        dct['input_ids'] = self.encoded_data[0][i]
        dct['attention_mask'] = self.encoded_data[1][i]
        dct['labels'] = self.label_list[i]
